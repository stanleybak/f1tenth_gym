...
from pkg.unc_disparity_extender import DisparityExtenderUNCDriver, DisparityExtenderDriving
...
class GymRunner(object):
    ...
    def run(self):
        ...
        if lookahead_off:
            print("WARNING: lookahead turned off")
            time.sleep(1)
        ...
        while num_success < 10:
            ...
            if env is None or num_success != 0:
                ...
                driver = DisparityExtenderUNCDriver(tuning_gains=True)
                ...
                backtrack_secs = 2 + DisparityExtenderDriving.SAME_POS_CRASH_COUNT // 2

                backtrack_secs = min(8, backtrack_secs)
            ...
            while not done:
                ...
                with concurrent.futures.ThreadPoolExecutor() as executor:
                    ...
                    for i, driver in enumerate(drivers):
                        ...
                        if scan_diff > 0.5 or lookahead_off:
                            scan = old_scan
                        else:
