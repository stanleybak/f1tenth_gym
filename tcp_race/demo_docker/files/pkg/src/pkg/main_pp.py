...
class GymRunner(object):
    ...
    def run(self):
        ...
        while num_success < 10:
            ...
            pp = MyPurePursuitPlanner(tuning_gains=True)

            render_funcs.clear()
            render_funcs.append(pp.render_waypoints)
            ...
            if crashed:
                pp.crashed() # update gains for next try

                num_success = 0
            else:
                num_success += 1
                print(f"Num success: {num_success} BREAK!")
