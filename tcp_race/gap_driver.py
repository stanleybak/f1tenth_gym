...
class Driver:
    ...
    it should implement process_lidar or process_observation
    """
    ...
    #    """process lidar scan and ego position to produce current control output"""

    #    return 0, 0

class GapFollower(Driver):
    BUBBLE_RADIUS = 160
