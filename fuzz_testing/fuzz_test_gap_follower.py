...
class GapFollowerDriver(Driver):
    ...
    def plan(self, obs, ego_index):
        ...
        my_lidar = obs['scans'][ego_index]

        return self.process_lidar(my_lidar)
...
def main():
    ...
    fuzz_test_gym(GapFollowerDriver, use_rrt=True, max_nodes=2000, load_progress_from_file=load_progress_from_file)
